...
class AnalyticsBase(BaseModel):
    ...
    avg_signal_strength: float | int = Field(
        default=...,
    ...
    peak_signal_strength: float | int = Field(
        default=...,
    ...
    min_signal_strength: float | int = Field(
        default=...,
    ...
    std_signal_strength: float | int = Field(
        default=...,
    ...
    avg_temperature: float | int = Field(
        default=...,
    ...
    peak_temperature: float | int = Field(
        default=...,
    ...
    min_temperature: float | int = Field(
        default=...,
    ...
    std_temperature: float | int = Field(
        default=...,
    ...
    avg_battery_percentage: float | int = Field(
    ...
    min_battery_percentage: float | int = Field(
        default=-1,
    ...
    efficiency_score: float | int = Field(
        default=...,
    ...
    energy_consumption: float | int = Field(
        default=...,
    ...
    operation_hours: float | int = Field(
        default=...,
